<x-body>
    <form method="POST" action="/auth" class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow">
        @csrf
        <h2 class="text-xl font-semibold text-gray-900 mb-8">Register</h2>
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button
                type="submit"
                class="px-4 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 rounded-md shadow"
            >
                Register
            </button>
        </div>
